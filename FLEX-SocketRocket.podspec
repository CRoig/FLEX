Pod::Spec.new do |spec|
  ...
  spec.homepage         = "https://github.com/CRoig/FLEX-SocketRocket"
  ...
  spec.author           = { "Carles Roig" => "carlesroiggarcia@gmail.com" }
  spec.social_media_url = "https://twitter.com/croigg"
  spec.platform         = :ios, "8.0"
  spec.module_name      = "FLEX"
  spec.source           = { :git => "https://github.com/CRoig/FLEX-SocketRocket.git", :tag => "#{spec.version}" }
